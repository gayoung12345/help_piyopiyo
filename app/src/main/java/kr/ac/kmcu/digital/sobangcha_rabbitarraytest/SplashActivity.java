...
public class SplashActivity extends AppCompatActivity {
    Activity            mActivity;
    ArrayList<Bitmap>   storyBmp = new ArrayList<>();         // 스토리 화면
    ...
    class MyView extends View {
        ...
        public MyView(Context context) {
            ...
            try {
                ...
                // 배경음
                descriptor = assetManager.openFd("start.mp3");
                mMediaPlayer.setDataSource(descriptor.getFileDescriptor(),descriptor.getStartOffset(),
                        descriptor.getLength() );
                mMediaPlayer.prepare();
                mMediaPlayer.setLooping(true);

                inputStream = assetManager.open("startImg.png");
                storyBmp.add( BitmapFactory.decodeStream(inputStream) );
                inputStream.close();

                inputStream = assetManager.open("story_1.png");
                storyBmp.add( BitmapFactory.decodeStream(inputStream) );
                inputStream.close();

                inputStream = assetManager.open("story_2.png");
                storyBmp.add( BitmapFactory.decodeStream(inputStream) );
                inputStream.close();

                inputStream = assetManager.open("story_3.png");
                storyBmp.add( BitmapFactory.decodeStream(inputStream) );
                inputStream.close();

                inputStream = assetManager.open("story_4.png");
                storyBmp.add( BitmapFactory.decodeStream(inputStream) );
                inputStream.close();

                inputStream = assetManager.open("story_5.png");
                storyBmp.add( BitmapFactory.decodeStream(inputStream) );
                inputStream.close();

                inputStream = assetManager.open("story_6.png");
                storyBmp.add( BitmapFactory.decodeStream(inputStream) );
                inputStream.close();

                inputStream = assetManager.open("story_7.png");
                storyBmp.add( BitmapFactory.decodeStream(inputStream) );
                inputStream.close();

                inputStream = assetManager.open("story_8.png");
                storyBmp.add( BitmapFactory.decodeStream(inputStream) );
                inputStream.close();
